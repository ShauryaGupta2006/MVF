...
function Home() {
    ...
    if (error) {
        return (
            <div className="min-h-[80vh] bg-zinc-950 text-white flex flex-col items-center justify-center px-4 relative overflow-hidden">
                {/* Liquid Glass Background Blobs with red tints */}
    ...
    const featuredMovie = movies && movies.length > 0 ? movies[0] : null;           // it checks the length of fetch data and if it is greater than 0 then set the starting as fetched for the time and use it as master image
