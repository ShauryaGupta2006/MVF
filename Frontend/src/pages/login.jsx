...
export default function Login() {
    ...
    return (
        <div className="min-h-screen bg-[#131314] text-[#e5e2e3] flex flex-col justify-center items-center p-4 sm:p-8 relative overflow-hidden font-sans selection:bg-violet-500/30 selection:text-violet-200">
            ...
            <div className="absolute bottom-[-15%] left-[-10%] w-130 h-130 bg-indigo-500/10 rounded-full blur-[150px] pointer-events-none animate-glow-pulse" />
            ...
            <div
                className={`w-full max-w-md relative z-10 space-y-6 transition-all duration-700 ease-out transform ${mounted ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-6 scale-95"
                    }`}
            >
                ...
                <div className="relative bg-[#1c1b1c]/80 border border-white/10 backdrop-blur-2xl p-6 sm:p-8 rounded-2xl shadow-2xl space-y-6 overflow-hidden">
                    ...
                    <div className="space-y-1.5 text-center sm:text-left">
                        ...
                        <p className="text-xs sm:text-sm text-gray-400">Sign in to access your AI movie forecasts & insights.</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            <div className="flex items-center justify-between">
                                ...
                                <a href="#" onClick={(e) => { e.preventDefault(); alert("Password reset link will be sent to your email."); }} className="text-xs text-violet-400 hover:text-violet-300 font-medium hover:underline transition-all">
                                    Forgot password?
                                </a>
                            </div>
                            <div className="relative group">
                        ...
                        <div className="flex items-center justify-between pt-1">
                            <label className="flex items-center gap-2.5 cursor-pointer text-xs text-gray-300 select-none">
                                <input
                                    ...
                                    className="w-4 h-4 rounded bg-[#131314] border-white/20 text-violet-600 focus:ring-violet-500 focus:ring-offset-0 focus:ring-2 accent-violet-600 cursor-pointer"
                                />
                    ...
                    <div className="text-center pt-2 border-t border-white/5">
                        <p className="text-xs sm:text-sm text-gray-400">
                            ...
                            <Link to="/auth/signup" className="text-violet-400 hover:text-violet-300 font-semibold hover:underline transition-all">
                                Create one here
                            </Link>
                        </p>
                    </div>
