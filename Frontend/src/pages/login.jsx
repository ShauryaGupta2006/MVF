...
export default function Login() {
    ...
    // Trigger smooth entrance transition on mount
    useEffect(() => {
        ...
        <div className="min-h-screen bg-[#131314] text-[#e5e2e3] flex flex-col justify-center items-center p-4 sm:p-8 relative overflow-hidden font-sans selection:bg-violet-500/30 selection:text-violet-200">
            ...
            >
                ...
                <div className="relative bg-[#1c1b1c]/80 border border-white/10 backdrop-blur-2xl p-6 sm:p-8 rounded-2xl shadow-2xl space-y-6 overflow-hidden">
                    ...
                    {/* Moving Accent Light Beam along the top border */}
                    ...
                    <div className="space-y-1.5 text-center sm:text-left">
                        ...
                        <p className="text-xs sm:text-sm text-gray-400">Log in to your MovieForecasts account.</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-[11px] font-semibold uppercase tracking-wider text-gray-300" htmlFor="login-email">
                                Email Address
                            </label>
                        ...
                        <div className="space-y-1.5">
                            <div className="flex items-center justify-between">
                                <label className="block text-[11px] font-semibold uppercase tracking-wider text-gray-300" htmlFor="login-password">
                                    Password
                                </label>
                                <a 
                                    href="#" 
                                    onClick={(e) => { e.preventDefault(); setError("Password recovery link has been sent if account exists."); }} 
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full bg-[#131314] border border-white/10 rounded-xl py-3 pl-11 pr-11 text-white text-sm placeholder-gray-600 focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 focus:outline-none transition-all"
                                />
                                <button
                                    type="button"
                                    onClick={() => setShowPassword(!showPassword)}
                                    className="absolute inset-y-0 right-0 flex items-center pr-3.5 text-gray-500 hover:text-gray-300 transition-colors cursor-pointer"
                                    aria-label={showPassword ? "Hide password" : "Show password"}
                                >
                                    {showPassword ? (
                                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858-5.908a10.025 10.025 0 015.703 1.937M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                        ...
                        <div className="flex items-center justify-between pt-0.5">
                            <label className="flex items-center gap-2.5 cursor-pointer text-xs text-gray-400 select-none">
                                <input
                                    ...
                                    className="w-4 h-4 rounded bg-[#131314] border-white/10 text-violet-600 focus:ring-violet-500/20 accent-violet-600 cursor-pointer"
                                />
                    ...
                    <div className="relative my-4">
                        ...
                        <div className="relative flex justify-center text-xs">
                            <span className="px-3 bg-[#1c1b1c] text-gray-500 uppercase tracking-widest text-[10px] font-semibold">Or continue with</span>
                        </div>
                    </div>
                    ...
                    <div className="text-center pt-2 border-t border-white/5">
                        <p className="text-xs sm:text-sm text-gray-400">
                            ...
                            <Link to="/signup" className="text-violet-400 hover:text-violet-300 font-semibold hover:underline transition-all">
                                Create one here
                            </Link>
                        </p>
                    </div>
